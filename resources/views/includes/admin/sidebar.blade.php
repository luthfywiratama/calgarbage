        ...
        <div class="js-sidebar-scroll">
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                <a class="nav-main-link {{ (request()->is('admin/garbage-type*')) ? 'active' : '' }}" href="{{ route('admin.garbage-type.index') }}">
                  <i class="nav-main-link-icon si si-doc"></i>
                  <span class="nav-main-link-name">Garbage Type</span>
                </a>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link {{ (request()->is('admin/transaction*')) ? 'active' : '' }}" href="{{ route('admin.transaction.index') }}">
                  <i class="nav-main-link-icon si si-doc"></i>
